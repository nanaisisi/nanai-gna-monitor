<#
.SYNOPSIS
Build and package the nanai-gna-monitor app using winapp and MSIX.
...
try {
    ...
    $msixName = 'nanai-gna-monitor.msix'
    $msixPath = Join-Path $projectRoot $msixName
    $packageName = 'nanai-gna-monitor'
